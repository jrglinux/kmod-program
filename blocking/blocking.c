/*
 * blocking.c - create a /proc file, and if several processes try to open it
...
#define PROC_ENTRY_FILENAME "blocking"
...
{
    our_proc_file = proc_create(PROC_ENTRY_FILENAME, 0644, NULL,
