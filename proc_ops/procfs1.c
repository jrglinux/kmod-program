...
{
    static int finished = 0;  /*why static? used to read only once*/
    if (finished) {
...
#ifdef HAVE_PROC_OPS
static struct proc_ops file_ops_our_proc_file = {
...
{
    our_proc_file = proc_create(PROCFS_ENTRY_FILENAME, 0644, NULL, &file_ops_our_proc_file);
